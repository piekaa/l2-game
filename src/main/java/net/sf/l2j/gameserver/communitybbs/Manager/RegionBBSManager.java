...
public class RegionBBSManager extends BaseBBSManager
{
	...
	public synchronized void changeCommunityBoard()
	{
		...
		List<L2PcInstance> sortedPlayers = new FastList<>();
	...
	private void writeCommunityPages()
	{
		...
		{
			Map<String, String> communityPage = new ConcurrentHashMap<>();
			StringBuilder htmlCode = new StringBuilder("<html><body><br>");
			String tdClose = "</td>";
	...
	{
		final Map<String, String> communityPage = _communityPages.get(page);
		if (communityPage != null)
		{
			return communityPage.get(type);
		}
		return null;
	}
}